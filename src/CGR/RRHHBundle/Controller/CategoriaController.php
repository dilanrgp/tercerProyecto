...
use CGR\RRHHBundle\Entity\Categoria;
...
class CategoriaController extends Controller {
    ...
    public function indexAction() {
        ...
        $categorias = $em->getRepository('RRHHBundle:Categoria')->findAll();
    ...
    public function newAction(Request $request) {
        ...
        $form = $this->createForm('CGR\RRHHBundle\Form\CategoriaType', $categorium);
    ...
    public function editAction(Request $request, Categoria $categorium) {
        $deleteForm = $this->createDeleteForm($categorium);
        $editForm = $this->createForm('CGR\RRHHBundle\Form\CategoriaType', $categorium);
